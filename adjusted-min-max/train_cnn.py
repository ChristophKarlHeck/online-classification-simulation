...
path_pattern = "/home/chris/experiment_data/*/training_data_wrong"
...
test_loader = DataLoader(test_dataset, batch_size=16, num_workers=7)

# Train the Model
model = Conv1DModel(input_channels=1, output_channels=64, kernel_size=5, lr=0.0007155964759471105)
