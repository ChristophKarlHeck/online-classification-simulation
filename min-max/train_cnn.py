...
class Conv1DModel(pl.LightningModule):
    def __init__(self, input_channels, output_channels=16, kernel_size=3, hidden_units=32, lr=1e-3):
        ...
        self.linear_1 = nn.Linear(self.flattened_size, 64)
...
model = Conv1DModel.load_from_checkpoint(
    "/home/chris/watchplant_classification_dl/pipline_test/lightning_logs/version_504/checkpoints/epoch=33-step=7242.ckpt",
    input_channels=1,
    output_channels=8,
    kernel_size=5,
    lr=4.776508681114144e-05)
