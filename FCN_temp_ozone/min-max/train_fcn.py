...
model = FCN.load_from_checkpoint(
    "/home/chris/watchplant_classification_dl/pipline_test/FCN_temp_ozone/lightning_logs/version_142/checkpoints/epoch=249-step=39250.ckpt",
    output_channels_1 = 4,
