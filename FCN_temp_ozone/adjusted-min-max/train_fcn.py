...
model = FCN.load_from_checkpoint(
    "/home/chris/watchplant_classification_dl/pipline_test/FCN_temp_ozone/lightning_logs/version_69/checkpoints/epoch=252-step=39215.ckpt",
    output_channels_1 = 8,
