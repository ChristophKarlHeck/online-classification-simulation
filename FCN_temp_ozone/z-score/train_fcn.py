...
model = FCN.load_from_checkpoint(
    "/home/chris/watchplant_classification_dl/pipline_test/FCN_temp_ozone/lightning_logs/version_84/checkpoints/epoch=183-step=28520.ckpt",
